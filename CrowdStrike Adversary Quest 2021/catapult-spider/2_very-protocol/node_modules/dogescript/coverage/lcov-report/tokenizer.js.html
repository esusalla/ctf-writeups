...
<head>
    <title>Code coverage report for tokenizer.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> tokenizer.js</h1>
        <div class='clearfix'>
...
&nbsp;
    if (!inString &amp;&amp; isWhiteSpace(c)) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (currToken.trim().length &gt; 0) {
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Tue Mar 17 2020 21:28:30 GMT-0500 (Central Daylight Time)
            </div>
        </div>
