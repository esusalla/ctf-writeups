...
<head>
    <title>Code coverage report for dogescript/lib/handlers/commentHandlers.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="..\..\..\index.html">All files</a> / <a href="index.html">dogescript/lib/handlers</a> commentHandlers.js</h1>
        <div class='clearfix'>
...
<a name='L94'></a><a href='#L94'>94</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">3x</span>
...
&nbsp;
  var tokens = parseContext.tokens;
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!parserState.hasState(StateEnum.MULTILINE_COMMENT)) {
