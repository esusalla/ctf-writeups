...
<head>
    <title>Code coverage report for dogescript/lib/handlers/classHandlers.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="..\..\..\index.html">All files</a> / <a href="index.html">dogescript/lib/handlers</a> classHandlers.js</h1>
        <div class='clearfix'>
...
<a name='L187'></a><a href='#L187'>187</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">3x</span>
...
&nbsp;
  ...
  if (tokens.length &gt; 0) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (nextToken == "grows") {
...
&nbsp;
  ...
  tokens.shift();
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (tokens.length &lt; 1) {
