...
<head>
    <title>Code coverage report for dogescript/lib/util/tokenUtils.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="..\..\..\index.html">All files</a> / <a href="index.html">dogescript/lib/util</a> tokenUtils.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const validTokens = [
  "such",
  "wow",
  "wow&amp;",
  "plz",
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!foundToken) {
