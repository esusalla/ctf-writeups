...
<head>
    <title>Code coverage report for dogescript/lib/handlers/invocationHandlers.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="..\..\..\index.html">All files</a> / <a href="index.html">dogescript/lib/handlers</a> invocationHandlers.js</h1>
        <div class='clearfix'>
...
<a name='L262'></a><a href='#L262'>262</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">3x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var tokenUtils = require("../util/tokenUtils");
...
function handleDose(parseContext) {
  var tokens = parseContext.tokens;
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (tokens[0] !== "dose" &amp;&amp; tokens[1] !== "dose") {
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (statement.includes(", ]")) {
<span class="cstat-no" title="statement not covered" >    statement += statement.replace(/, ]/g, "]");</span>
  }
  <span class="missing-if-branch" title="if path not taken" >I</span>if (statement.includes(", }")) {
<span class="cstat-no" title="statement not covered" >    statement = statement.replace(/, }/g, "}");</span>
  }
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (tokens[0] !== "with") {
<span class="cstat-no" title="statement not covered" >    throw new Error(</span>
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (object.slice(-1) === "&amp;") {
<span class="cstat-no" title="statement not covered" >    object = object.slice(0, -1);</span>
<span class="cstat-no" title="statement not covered" >    statement += object + "()\n";</span>
  } else {
    statement += object + "();\n";
  }
&nbsp;
