...
<head>
    <title>Code coverage report for dogescript/lib/handlers/moduleHandlers.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="..\..\..\index.html">All files</a> / <a href="index.html">dogescript/lib/handlers</a> moduleHandlers.js</h1>
        <div class='clearfix'>
...
&nbsp;
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (assignmentValue === "much") {
