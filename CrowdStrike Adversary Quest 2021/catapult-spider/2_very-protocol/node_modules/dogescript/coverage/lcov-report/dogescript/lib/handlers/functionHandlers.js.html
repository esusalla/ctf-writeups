...
<head>
    <title>Code coverage report for dogescript/lib/handlers/functionHandlers.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="..\..\..\index.html">All files</a> / <a href="index.html">dogescript/lib/handlers</a> functionHandlers.js</h1>
        <div class='clearfix'>
...
<a name='L121'></a><a href='#L121'>121</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">3x</span>
...
&nbsp;
  // no args or some other unrecognized token
  return statement + " () { \n";
}
&nbsp;
/**
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (parseContext.tokens.length &lt; 1) {
