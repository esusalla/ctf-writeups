...
<head>
    <title>Code coverage report for dogescript/lib/handlers/operatorHandlers.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="..\..\..\index.html">All files</a> / <a href="index.html">dogescript/lib/handlers</a> operatorHandlers.js</h1>
        <div class='clearfix'>
...
<a name='L264'></a><a href='#L264'>264</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">3x</span>
...
function handleIncrementDecrementOperators(parseContext) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!containsIncrementDecrement(parseContext)) {
