/*
Edited and adjusted for local testing
*/
...
var networker_file = fs.readFileSync('./networker.js').toString('utf-8');
var Networker = eval(networker_file);
...
const server = tls.createServer(options, (socket) => {
    ...
    let networker = new Networker(socket, (data) => {
        ...
        console.log("DECODED MSG:", dson.parse(doge_lingo));
